<template>
	...
	<el-dialog v-model="dialogVisible" :title="currentUpdateId === undefined ? '新增' : '修改'" @close="resetForm" width="50%">
		<el-form ref="formRef" :model="formData" :rules="formRules" label-width="100px" label-position="right">
			...
			<el-form-item prop="tagId" label="标签标识">
				<el-input v-model="formData.tagId" placeholder="请输入" />
			</el-form-item>
			<el-form-item>
...
import { getApi, createApi, updateApi } from "@/api/blogs/articleTag"
...
const formRules: FormRules = reactive({
	...
	tagId: [{ required: true, trigger: "blur", message: "请输入标签标识" }]
})
const handleCreate = () => {
