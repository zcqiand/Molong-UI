	...
	<div class="app-container">
		<el-card v-loading="loading" shadow="never">
			...
			<div class="toolbar-wrapper">
				<div>
					<el-button type="primary" :icon="CirclePlus" @click="handleAdd">发布文章</el-button>
				...
				<el-table :data="tableData" row-key="id" @selection-change="selectionChange" border default-expand-all>
					...
					<el-table-column prop="tags" label="标签" width="170" align="center">
						<template #default="scope">
							<el-tag v-for="item of scope.row.tags" :key="item.id" style="margin-top: 0.2rem; margin-right: 0.2rem">
								{{ item.name }}
							</el-tag>
						</template>
					</el-table-column>
					<el-table-column prop="likes" label="点赞数" width="90" align="center" />
					<el-table-column prop="collections" label="收藏数" width="90" align="center" />
					<el-table-column prop="publishDate" :formatter="dateFormat" label="发布时间" width="150" align="center" />
...
import { deleteApi, batchDeleteApi, queryApi } from "@/api/blogs/article"
...
const handleEdit = (row: any) => {
	router.push(`/management/article/${row.id}`)
}
//更多命令
